          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                ...
                <form class="form-horizontal form-label-left" method="post" action="{{route('store.products')}}" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="integer"  name="product_code"  class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                        <input type="integer" name="product_quantity" class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
